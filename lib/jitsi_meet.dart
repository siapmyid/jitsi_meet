...
class JitsiMeetingOptions {
  ...
  @override
  String toString() {
    return 'JitsiMeetingOptions{serverURL: $serverURL, room: $room, subject: $subject, token: $token, audioMuted: $audioMuted, audioOnly: $audioOnly, videoMuted: $videoMuted, userDisplayName: $userDisplayName, userEmail: $userEmail}';
  }
